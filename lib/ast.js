...
exports.While = While = (function(superclass){
  ...
  prototype.addBody = function(body){
    ...
    this.body = body;
    if (this.guard) {
      this.body = Block(If(this.guard, this.oldBody = body));
    }
  ...
  prototype.makeReturn = function(it){
    ...
    if (it) {
      if (this.objComp) {
        ...
        body = (ref$ = this.oldBody) != null
          ? ref$
          : this.body;
        last = (ref$ = body.lines) != null ? ref$[ref$.length - 1] : void 8;
...
exports.For = For = (function(superclass){
  ...
  prototype.addBody = function(body){
    ...
    if (this['let']) {
      ...
      this.body = Block(Call['let']((x$ = [], (that = (ref$ = this.index, delete this.index, ref$)) && x$.push(Assign(Var(that), Literal('index'))), (that = (ref$ = this.item, delete this.item, ref$)) && x$.push(Assign(that, Literal('item'))), x$), body));
    }
    return this;
  };
  prototype.compileNode = function(o){
