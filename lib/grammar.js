...
bnf = {
  Head: [
    o('ID', function(){
      ...
      return $3[0].makeComprehension($2, $3.slice(1));
    }), o('[ Expression LoopHeads DEDENT ]', function(){
      return $3[0].makeComprehension($2, $3.slice(1));
    }), o('{ [ ArgList OptComma ] LoopHeads }', function(){
      return $6[0].addObjComp().makeComprehension(L(Arr($3)), $6.slice(1));
    }), o('( BIOP )', function(){
      return Binary($2);
    }), o('( BIOP Expression )', function(){
      return Binary($2, void 8, $3);
    }), o('( Expression BIOP )', function(){
      return Binary($3, $2);
    }), o('( BIOPR )', function(){
      if ('!' === $2.charAt(0)) {
        return Binary($2.slice(1)).invertIt();
      } else {
        return Binary($2);
      }
    }), o('( BIOPR Expression )', function(){
      if ('!' === $2.charAt(0)) {
        return Binary($2.slice(1), void 8, $3).invertIt();
      } else {
        return Binary($2, void 8, $3);
      }
    }), o('( Expression BIOPR )', function(){
      if ('!' === $3.charAt(0)) {
        return Binary($3.slice(1), $2).invertIt();
      } else {
        return Binary($3, $2);
      }
    }), o('( BIOPBP )', function(){
